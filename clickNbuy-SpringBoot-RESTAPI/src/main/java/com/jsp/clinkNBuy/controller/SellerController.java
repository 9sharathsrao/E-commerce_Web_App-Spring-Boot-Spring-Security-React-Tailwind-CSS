...
public class SellerController {
	...
	@GetMapping("/category")
	@Operation(summary = "Fetch All Categories for Seller", security = @SecurityRequirement(name = "bearerAuth"))
	@ResponseStatus(value = HttpStatus.OK)
	public ResponseDto viewCategories() {
	    return sellerService.viewCategories(); // You may need to add this method in SellerService too
	}
