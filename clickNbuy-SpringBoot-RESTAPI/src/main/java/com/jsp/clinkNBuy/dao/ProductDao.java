...
public class ProductDao {
	...
	public List<Product> findApprovedProducts(Pageable pageable) {
        // Change: Be careful with findByApprovedTrue if your DB stores it as 1
        // If your Entity uses 'boolean approved', this is fine. 
        // If it uses 'int approved', we'd need findByApproved(1, pageable).
        List<Product> products = productRepository.findByApprovedTrue(pageable);
        
        // Suggestion: Don't throw an exception here. 
        // Returning an empty list is better for a Home Page so the UI can show "No Products" 
        // instead of a 404/500 error page.
        return products; 
    }
